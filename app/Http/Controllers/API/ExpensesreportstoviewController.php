...
use App\Expensereporttoviewselection;
...
$myrecordexists = \DB::table('expensereporttoviewselections')->where('ucret', '=', $userid)->count();
if($myrecordexists < 1 )
{
    Expensereporttoviewselection::Create([
...
if($myrecordexists > 0){
  ...
  if($monthselection > 0)
  {
  $res = \DB::table('expensereporttoviewselections')->where('ucret', $userid)->update(['monthname' =>  $month]);
}
...
if($yearselection > 0)
{
$res = \DB::table('expensereporttoviewselections')->where('ucret', $userid)->update(['yearname' =>  $yeart]);
}
  ...
  {
  $res = \DB::table('expensereporttoviewselections')->where('ucret', $userid)->update(['branch' =>  $branch]);
}
$countryselection = strlen($country);
if($countryselection > 0)
{
$res = \DB::table('expensereporttoviewselections')->where('ucret', $userid)->update(['countryname' =>  $country]);
}

$companyselection = strlen($company);
if($companyselection > 0)
{
$res = \DB::table('expensereporttoviewselections')->where('ucret', $userid)->update(['companyname' =>  $company]);
}
...
{
$res = \DB::table('expensereporttoviewselections')->where('ucret', $userid)->update(['startdate' =>  $startdate]);
}

$enddateselection = strlen($enddate);
if($enddateselection > 0)
{
$res = \DB::table('expensereporttoviewselections')->where('ucret', $userid)->update(['enddate' =>  $enddate]);
}
