...
Invoincestoappenditem::Create([
  ...
  'invoiceno' => $request['suppliername'].$request['invoicenumber'].$myRandomString,
...
Invoicetoview::Create([
  ...
  'ucret' => $userid,
   ...
   Purchasessummary::Create([
      ...
      'supplierinvoiceno' =>$request['suppliername'].$request['invoicenumber'].$myRandomString,
...
Invoincestoappenditdddddddem::Create([
  ...
  'invoiceno' => $request['invoicenumber'].$myRandomString,
