...
/// Getting the active invoice
   ...
   // return   Purchase::latest('id')
    ...
    public function buyorsaletransaction(){
      $userid =  auth('api')->user()->id;
      $idto = \DB::table('statementrecordtoviews')->where('ucret', '=', $userid)->value('recordinaction');
     ...
     return   $recordtype = \DB::table('customerstatements')->where('invoiceinaction', '=', $invoicetoview)->value('acttrans');
    ...
    public function getstatementtransactions(){
      ...
      /////  getting the statement invoice
      $invoicetoview = \DB::table('customerstatements')->where('id', '=', $idto)->value('invoiceinaction');
   //// checking where the record lies
   $isitinpurchases = \DB::table('purchases')->where('supplierinvoiceno', '=', $invoicetoview)->count();
   $isitsales = \DB::table('productsales')->where('invoiceno', '=', $invoicetoview)->count();
if($isitinpurchases > 0)
   {
...
///////////////////////////////////////////////////////////////////////
    ...
    public function update(Request $request, $id)
    {
       ...
       $acttrans = \DB::table('customerstatements')->where('id', '=', $id)->value('acttrans');
       //getting the client type
      //  $clienttype = \DB::table('customerstatements')->where('id', '=', $id)->value('customername');
