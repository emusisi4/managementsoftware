...
class Orderdetail extends Authenticatable
{
    ...
    protected $fillable = [
        'productname','quantity', 'countryname', 'companyname', 'qtyperunit', 'linetotalcost','ucret','invoiceno','datemade','unitcost','lineunitcost','supplier','brand','unitofmeasure','smallunitmeasure'
