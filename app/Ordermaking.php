...
class Ordermaking extends Authenticatable
{
    ...
    protected $fillable = [
        'productname','quantity','countryname', 'companyname',  'qtyperunit', 'linetotalcost','ucret','datemade','unitcost','lineunitcost','supplier','brand','unitofmeasure','smallunitmeasure'
