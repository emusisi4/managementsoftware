...
class Product extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'productname', 'uracode', 'category', 'unitmeasure', 'rol', 'qty', 'ucret',
         'brand', 'description', 'unitcost', 'unitprice', 'del','salesturnover','countryname', 'companyname', 
         'discountstatus','discountedprice','creditsellingprice','stockvalue','laststockupdate'
