...
class Productdelivery extends Authenticatable
{
    ...
    protected $fillable = [
        'productname','orderdate', 'qtyordered', 'ordersupplier','ucret','orderingmainunit',
        'orderingsmallunit','orderingqtyperunit','orderingbrand','costpriceforunit','linecostprice','deliveringsupplier',
        'deliveringmainunit','qtyofunitsdelivered','qtyperunitdelivered','smallunitdelivered','sellingprice','yeardone',
        'monthdone','countryname', 'companyname', 
