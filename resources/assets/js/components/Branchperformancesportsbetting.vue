                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <!-- <li role="presentation" v-if="mainmenuaccessSettings > 0 "  >
                                    <a href="#messages_with_icon_title" data-toggle="tab"  @click="loadMainmenuaccess()">
                                        <i class="material-icons"></i> Main Menu
                                    </a>
                                </li>
...
<div class="modal fade" id="addnewshopbalancingrecord" data-backdrop="static">
         <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3  v-show="!editmode"    class="modal-title"><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">Add New Balancing Record</h3> 
                <h4  v-show="editmode" class="modal-title" >UPDATE RECORD</h4> 
                        </div>
