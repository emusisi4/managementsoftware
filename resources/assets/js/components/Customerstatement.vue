...
<div class="ticket" id="print" style="background-color: #ffffff; display:none" >
 <div class="ticketreceipttitle"  > CUSTOMER STATEMENT </div>
 <hr>
<div class=""> 
<div class="">
   <div v-if="customertype == '1' && customeraccountbalance >= '0' " class="proformarinvoicedatedetails"   > Amount Due : {{currencydetails}} {{formatPrice((customeraccountbalance))}}</div>
      <div v-if="customertype == '1' && customeraccountbalance <  '0' " class="proformarinvoicedatedetails"   > Balance : {{currencydetails}} {{formatPrice((customeraccountbalance*-1))}}</div>
</div>>

        <div v-if="customertype = '2' && customeraccountbalance >= '0' " class="proformarinvoicedatedetails"   > Balance: {{currencydetails}} {{formatPrice((customeraccountbalance))}}</div>
      <div v-if="customertype = '2' && customeraccountbalance <  '0' " class="proformarinvoicedatedetails"   > Amount Due  : {{currencydetails}} {{formatPrice((customeraccountbalance*-1))}}</div>
        
</div>
       <!-- <div class="verygoomain"> <b class="verygoodone">  </b>   <b class="verygoodtwo"> Account Summary </b></div>

        <div class="verygoomain"> <b class="verygoodone">  </b>    
...
<!-- axios.get("api/creditinvoicecustomername").then(({ data }) => (this.creditinvoicecustomername = data)); -->
 <div class="proformarinvoicecompanydetails"  > Name {{customernamestatementprint}} </div>
          <div class="proformarinvoicecompanydetails"  > Address : {{customeraddresstoprint}}</div>
           <div class="proformarinvoicecompanydetails"  >Contact : {{cuctomercontacttoprint}} </div>
                      


  <b class="proformarinvoicecompanydetails">Account Activity</b>
...
<tr>
      ...
      <td style="width:100px" class="musisialignleft">{{prodcates.transactiondate  }}</td>
  ...
  <table  class="musisireporttable" width="100%" border="1">
       ...
       <tr>
             ...
             <th colspan="1"  style="font-size: 18px;   text-align:left;  border-bottom: 4px solid rgb(124 102 102); 
                ...
                <th colspan="1"  style="font-size: 18px; text-align:left;    
               border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"><div v-if="buyorsaletransaction == '4' "> Uunit Cost </div>
               <div v-if="buyorsaletransaction == '3' "> Unit Price </div>
               </th>
     ...
     <th colspan="1"  style="font-size: 18px; text-align:left;    
           ...
           <th colspan="1"  style="font-size: 18px; text-align:center;    
               border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"> <div v-if="buyorsaletransaction == '4' "> Total Cost </div>
               <div v-if="buyorsaletransaction == '3' "> Total Price </div>	</th>
...
<div v-if="buyorsaletransaction == '4' "> {{(purcdet.qtydelivered)  }} </div>
<div v-if="buyorsaletransaction == '3' "> {{(purcdet.quantity)  }} </div>
      ...
      <td class="musisialignright"> {{formatPrice(purcdet.totaltaxdelivered)  }}
        <div v-if="buyorsaletransaction == '4' "> {{(purcdet.totaltaxdelivered)  }} </div>
<div v-if="buyorsaletransaction == '3' "> {{(purcdet.vattotal)  }} </div>

        </td>   
     <td class="musisialignright">
        <div v-if="(formatPrice(purcdet.totalcostdeliverywithtax) >= 0)">  {{formatPrice(purcdet.totalcostdeliverywithtax)  }}</div> {{formatPrice(purcdet.vatamount)  }}</td>   
...
customernamestatementprint:{},
customeraddresstoprint:{},
cuctomercontacttoprint:{},
...
axios.get("api/customerstatementrecords").then(({ data }) => (this.customerstatementrecords = data));
axios.get("api/customernamestatementprint").then(({ data }) => (this.customernamestatementprint = data));
axios.get("api/customeraccountbalance").then(({ data }) => (this.customeraccountbalance = data));
axios.get("api/cuctomercontacttoprint").then(({ data }) => (this.cuctomercontacttoprint = data));
axios.get("api/customeraddresstoprint").then(({ data }) => (this.customeraddresstoprint = data));
axios.get("api/customertypeprint").then(({ data }) => (this.customertypeprint = data));
...
// if (result.isConfirmed) {
 //  this.form.delete('api/invoicenumbertocheck/'+id);
   this.form.put('api/statementrecordtoview/'+id);
    ...
    axios.get("api/buyorsaletransaction").then(({ data }) => (this.buyorsaletransaction = data));
