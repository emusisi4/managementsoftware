                      ...
                      <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                             <select name ="mycpmponentto" v-model="form.mycpmponentto" class="form-control show-tick" data-live-search="true" id ="mycpmponentto" v-on:change="myClickEventroletoaddcomponent"  :class="{'is-invalid': form.errors.has('mycpmponentto')}">
                    <option value=" ">  </option>
            ...
            <table class="table">
                  ...
                  <tbody>
                    <tr>
                                ...
                                <td>{{allbrmac.id}}</td>
                                <td>{{allbrmac.created_at | myDate }}</td>  
    <td> <template v-if="allbrmac.code_country">	{{allbrmac.code_country.countryname}}</template></td>
   <td> <template v-if="allbrmac.code_company">	{{allbrmac.code_company.companyname}}</template></td>
...
<div class="modal fade" id="addnewCompanyreg" data-backdrop="static">
         <div class="modal-dialog modal-lg" role="document">
                ...
                <h4  v-show="editmode" class="modal-title" >UPDATE RECORD</h4> 
                  ...
                  <form class="form-horizontal" @submit.prevent="editmode ? updateCompanydetails():createNewfishmachine()"> 

                
<div class ="bethapa-table-sectionheader">MAchine Details</div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Machine name</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                      ...
                      class="form-control" :class="{ 'is-invalid': form.errors.has('machinename') }">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Descripption</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                              <has-error :form="form" field="companyname"></has-error>
                                                   <select name ="type" v-model="form.companyname"  v-on:change="submitcompanyinaction"  id ="companyname" :class="{'is-invalid': form.errors.has('countryname')}"
...
newmachineaccessbranch(){
     ...
     $('#addnewmachineaccessbranch').modal('show');
            },
 loadAuthorisedbranchmachines(){
  ...
  createnewBranchmachine(){
    ...
    $('#addnewmachineaccessbranch').modal('hide');
...
///////////////////////////////////////////////////
        created() {
            ...
            this.loadAuthorisedbranchproducts();
            this.loadMacines();
