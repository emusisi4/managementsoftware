                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#home_with_icon_title" @click="loadBranches()" data-toggle="tab">
                                        <i class="material-icons"></i> BRANCHES
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#profile_with_icon_title" @click="loadSuppliers()" data-toggle="tab">
                                        <i class="material-icons"></i> Suppliers
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#messages_with_icon_title" data-toggle="tab">
                                        <i class="material-icons"></i> Customers
                                    </a>
                                </li>
                                <li role="presentation">
                  ...
                  <tbody>
                    <tr>
                                ...
                                <td>{{branchesdata.id}}</td>
                                  ...
                                  <td>   <template v-if="branchesdata.country_branch">	{{branchesdata.country_branch.countryname}}</template></td>  
             <td>   <template v-if="branchesdata.company_det">	{{branchesdata.company_det.companyname}}</template></td>  
...
<div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               ...
                                               <select name ="companyname" v-model="form.companyname"  v-on:focus ="getcompanies()" id ="companyname" :class="{'is-invalid': form.errors.has('companyname')}"
                                      class="form-control show-tick" data-live-search="true">
                                        <option></option>
                    ...
                    <has-error :form="form" field="contact"></has-error>
                                        ...
                                        <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2"> B/F</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
