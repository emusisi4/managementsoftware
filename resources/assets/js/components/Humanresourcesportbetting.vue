...
<div  v-if="gencomponentaccessHrms > 0 "> 
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#profile_with_icon_title" @click="loadSuppliers()" data-toggle="tab">
                                        <i class="material-icons">face</i> Employees
                                    </a>
                                </li>
                                <!-- <li role="presentation">
                      ...
                      Branches Details 
                      <button type="button" v-if="allowedtoaddbranch > 0 " v-on:click ="companylistttt()" class="add-newm" @click="newBranchmodal" >Add New </button> 
                     </div>
                    ...
                    <tr>
                                ...
                                <td>{{branchesdata.id}}</td>
                                 <td>{{branchesdata.branchname | firstletterCapital }}</td>
                                  <td> 
                                     <template v-if="branchesdata.company_det">	{{branchesdata.company_det.companyname}}</template> 
                                  </td>
...
<div class="modal fade" id="addnewBranchmodal" data-backdrop="static">
...
<div class ="bethapa-table-sectionheader">Branch Details</div>
                    ...
                    <has-error :form="form" field="openningbalance"></has-error>
                                 ...
                                 <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Company Branch</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               
                                     <select name ="type" v-model="form.companybranch"  id ="companybranch" :class="{'is-invalid': form.errors.has('companybranch')}"
                    ...
                    <has-error :form="form" field="companybranch"></has-error>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
getcompaniesdetails: function(){ axios.get('/api/getcompaniesdetails').then(function (response) { this.companieslist = response.data;}.bind(this));},
...
this.loadBranches();
 ...
 // setInterval(() =>this.getcompaniesdetails(),3000);
        }
    }
</script>
