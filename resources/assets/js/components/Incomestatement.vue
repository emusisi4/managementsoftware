...
<div class="ticket" id="print">
        <div class="ticketcompanyname"  > Ssennah Hardware </div>
          <div class="ticketlocation"  > Income statement </div>
           <div class="ticketlocation"   > From : {{incomestatementstartdate}}  To: {{incomestatementenddate}} </div>
           
          
          
<table  class="" width="100%">
       <tr>
<th style="text-align: left; font-size: 25px; background: #fff;">  Revenue / Turnover / Sales	</th>
           
              
                 <th style="font-size: 25px; text-align: right; width: 355px; background: #fff;"> {{formatPrice(incomestatementsales)}} </th>
...
<table  class="" width="100%">
       <tr>
             <th style="text-align: left; font-size: 25px; background: #fff;"> Opening Stock	</th>
           
           
                 <th style="font-size: 25px; text-align: right;width: 355px; background: #fff;"> <i>n/a </i> </th>
...
<table  class="" width="100%">
       <tr>
             <th style="text-align: left; font-size: 25px; background: #fff;">Closing Stock	</th>
...
<table  class="" width="100%">
       <tr>
             <th style="text-align: left; font-size: 25px; background: #fff;">Purchases Made	</th>
...
<table  class="" width="100%">
       <tr>
             <th style="text-align: right; font-size: 25px; background: #fff;">Cost of sales	</th>
           
             
                 <th style="font-size: 25px; text-align: right; width: 355px; text-align: right; background: #fff;">{{formatPrice(incomestatementcostofsales)}}  </th>
...
<table  class="" width="100%">
       <tr>
             <th style="text-align: right; font-size: 25px; background: #fff;">Gross profit	</th>
           
              
                 <th style=" font-size: 25px; text-align: right; width: 355px; background: #fff;">{{formatPrice(incomestatementgrossprofit)}} </th>
...
<div style="    text-align: left; font-size: 28px; color:black"><b>Miscellaneous/Other Incomes</b> </div>
...
<table  class="" width="100%" border="1">
    <tr> 
         ...
         <tr v-for="prodcates in incomestotherincomesrecords.data" :key="prodcates.id">
            
             <td style="text-align: left; color:black"  > <template v-if="prodcates.company_incomesourcenames">	{{prodcates.company_incomesourcenames.incomesourcename}}</template> </td>
             <td style="text-align: left; color:black" >{{(prodcates.daterecieved)}}</td>
               <td style="text-align: right; color:black" >{{formatPrice(prodcates.amount)}}</td>
...
<th style="font-size: 18px; text-align:center;    
                ...
                background-color:rgb(255 255 255); color: #131378;" >
...
<div class="musisialignright"> TOTAL INCOMES </div>
</th>
...
<th style="font-size: 18px; text-align:center;    
                ...
                background-color: rgb(255 255 255); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(incomestatementotherincomes)}} </div>
</th>
    </tr>
</table>


<div style="    text-align: left; font-size: 28px; color:black"><b>EXPENSES</b> </div>

<b   style="font-size: 23px; text-align: left;"  >Operational </b>
...
<table  class="" width="100%" border="1">
    <tr> 
         ...
         <tr v-for="prodcates in operationalexpenserecords.data" :key="prodcates.id">
            
             <td style="text-align: left; color:black"  > 
                 <template v-if="prodcates.expense_name">	{{prodcates.expense_name.expensename}}</template>
                  </td>
              <td style="text-align: left; color:black"  >{{(prodcates.datemade)}}</td>
               <td style="text-align: right; color:black" >{{formatPrice(prodcates.amount)}}</td>
 <td style="text-align: right; color:black" ></td>
...
<th style="font-size: 18px; text-align:center;    
                ...
                background-color: rgb(255 255 255);" >
<div class="musisialignright"> TOTAL </div>
</th>
...
<th style="font-size: 18px; text-align:center;    
                ...
                background-color: rgb(255 255 255); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(operationsexpensestotal)}} </div>
</th>
    </tr>
</table>
...
<b   style="font-size: 23px; text-align: left;"  >Administrative Expenses </b>
<table  class="" width="100%" border="1">
    <tr> 
         ...
         <tr v-for="prodcates in administrativeexpenserecords.data" :key="prodcates.id">
...
<th style="font-size: 18px; text-align:center;    
                ...
                background-color: rgb(255 255 255); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(administrativeexpensestotal)}} </div>
</th>
    </tr>
</table>


<b   style="font-size: 23px; text-align: left;"  >Finance Expenses </b>
...
<table  class="" width="100%" border="1">
    <tr> 
         ...
         <tr v-for="prodcates in financeexpenserecords.data" :key="prodcates.id">
...
<th style="font-size: 18px; text-align:center;    
                ...
                background-color: rgb(255 255 255); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(financeexpensestotal)}} </div>
</th>
    </tr>
</table>
...
<table  class="" width="100%">
       <tr>
<th style="text-align: right; font-size: 25px; background: #fff;">  GROSS PROFIT BEFORE TAXES	</th>
           
              
                 <th style="font-size: 25px; text-align: right; width: 355px; background: #fff;"> {{currencydetails}} {{formatPrice(
incomestatementgrossprofit+incomestatementotherincomes-operationsexpensestotal-administrativeexpensestotal

-financeexpensestotal)}} </th>
...
salessummaryComponentaccess:'',
 ...
 incomestatementotherincomes:{},
 administrativeexpensestotal:{},
financeexpensestotal:{},
operationsexpensestotal:{},
 operationalexpenserecords:{},
  financeexpenserecords:{},
   administrativeexpenserecords:{},
...
incomestatementopenningstock:{},
incomestatementclosingstock:{},
incomestatementpurchases:{},
incomestatementcostofsales:{},
incomestatementgrossprofit:{},
incomestatementtotalexpenses:{},
incomestatementotherincomes:{},
incomestatementoperationalexp:{},
incomestatementadminexp:{},
incomestatementfinanceexp:{},
...
loadvatvalues(){
    ...
    /// other incomes
    axios.get("api/incomestotherincomesrecords").then(({ data }) => (this.incomestotherincomesrecords = data)); 
...
axios.get('/api/incomestatementoperationalexp').then(function (response) { this.incomestatementoperationalexp = response.data;}.bind(this));
axios.get("api/incomestatementotherincomes").then(({ data }) => (this.incomestatementotherincomes = data));

axios.get("api/administrativeexpensestotal").then(({ data }) => (this.administrativeexpensestotal = data));

axios.get("api/financeexpensestotal").then(({ data }) => (this.financeexpensestotal = data));

axios.get("api/operationsexpensestotal").then(({ data }) => (this.operationsexpensestotal = data));



axios.get("api/administrativeexpenserecords").then(({ data }) => (this.administrativeexpenserecords = data));

axios.get("api/financeexpenserecords").then(({ data }) => (this.financeexpenserecords = data));

axios.get("api/operationalexpenserecords").then(({ data }) => (this.operationalexpenserecords = data));
...
axios.get("api/incomestatementtotalexpenses").then(({ data }) => (this.incomestatementtotalexpenses = data));
axios.get("api/incomestatementgrossprofit").then(({ data }) => (this.incomestatementgrossprofit = data));
axios.get("api/incomestatementcostofsales").then(({ data }) => (this.incomestatementcostofsales = data));
axios.get("api/incomestatementsales").then(({ data }) => (this.incomestatementsales = data));
axios.get("api/incomestatementopenningstock").then(({ data }) => (this.incomestatementopenningstock = data));
axios.get('/api/incomestatementfinanceexp').then(function (response) { this.incomestatementfinanceexp = response.data;}.bind(this));
axios.get('/api/incomestatementadminexp').then(function (response) { this.incomestatementadminexp = response.data;}.bind(this));
axios.get("api/incomestatementclosingstock").then(({ data }) => (this.incomestatementclosingstock = data));
axios.get("api/incomestatementpurchases").then(({ data }) => (this.incomestatementpurchases = data));
axios.get('/api/incomestatementenddate').then(function (response) { this.incomestatementenddate = response.data;}.bind(this));
axios.get('/api/incomestatementstartdate').then(function (response) { this.incomestatementstartdate = response.data;}.bind(this));
