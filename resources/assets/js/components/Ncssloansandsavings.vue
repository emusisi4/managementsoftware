...
<div class="col-md-12">
              <div class="card">
                <div class="d-flex  border-bottom title-part-padding align-items-center ">
                  <div>
                    <h2 class="card-title mb-0"> LOANS AND SAVINGS SCHEME</h2>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab"  @click="getClientloansaccount()" href="#home" role="tab">
                          <span>Loans Accounts Standing</span>
                        </a>
                      </li>

                        <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab"  @click="loadClientloans()" href="#clientloans" role="tab">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab"  @click="loadSubmenus()" href="#profile" role="tab">
                          <span>Loan Payment Details</span>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab"  @click="loadVuecomponents()" href="#messages" role="tab">
                          <span>Client Savings Account</span>
                        </a>
                      </li>


                        <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab"  @click="loadComponentfeatures()" href="#messages1" role="tab">
                          <span>Client Withdraw Details</span>
                        </a>
                      </li>
                    ...
                    Client Account Details and Account Balance
                     <!-- <button  type="button" class="add-newm" @click="newLoanapplication" >Apply for New Loan </button> -->
                     </div>
...
<div class="card">
            ...
            <table class="table customize-table mb-0 v-middle">
                  ...
                  <tbody>
                    <tr>
                       ...
                       <tr v-for="clientinfo in ncssloansaccountrecords.data" :key="clientinfo.id">
                                                  
                    <td>{{clientinfo.id}}</td>
                    
                     <!-- <td>{{clientinfo.firstname}} {{clientinfo.middlename}} {{clientinfo.lastname}}</td> -->
                      <td>
                         <template v-if="clientinfo.client_loanaccount">	{{clientinfo.client_loanaccount.firstname}} 
                           	{{clientinfo.client_loanaccount.middlename}} 	{{clientinfo.client_loanaccount.lastname}}</template>
                      </td>
                     <td style="text-align:right; padding-right: 25px;">{{clientinfo.accountnumber }}</td>
            
                     <!-- <td>{{clientinfo.dateopenned}}</td> -->
                     <!-- <td>{{clientinfo.latesttransactiondate  }}</td>
                     <td>{{clientinfo.datejoined  }}</td> -->
                     <td style="text-align:right; padding-right: 25px;">{{clientinfo.accountbalance  }}</td>
        ...
        <button type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-info " @click="SaveClienttoviewdetails(clientinfo.clientname), vewClientloans(clientinfo)"> View Loans </button> 
                                               </a>  
             <!--
<a href="#"><button type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-primary fas fa-edit " @click="editSubmenu(clientinfo)"> Edit </button> 
                                   
                                
                
             <button type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-danger " @click="deleteSubmenu(clientinfo.id)"> Del </button>  -->
                               <!-- </a> -->
                      </td>
                    </tr>
    ...
    <div class="card-footer">
                <ul class="pagination pagination-sm m-0 float-right">
                   <pagination :data="branchesrecords" @pagination-change-page="paginationResultsBranches"></pagination>
                      ...
                      <div class="tab-pane p-3" id="clientloans" role="tabpanel">
                     
                                                        <div class="bethapa-table-header">
                      Client Loans Details
                        <button  type="button" class="add-newm" @click="newLoanapplication" >Apply for New Loan </button>
                     </div>
     <div class="table-responsive">
            <table class="table customize-table mb-0 v-middle">
                  ...
                  <tbody>
                    <tr>
                       ...
                       <tr v-for="clientinfo in ncssloansrecords.data" :key="clientinfo.id">
                                                  
                    <td>{{clientinfo.id}}</td>
                    <td style="text-align:left; padding-left: 25px;">{{clientinfo.loannumber}}</td>
                       <td style="text-align:left; padding-left: 25px;">{{clientinfo.requestdate}}</td>
                    
                     
                      <td>
                         <template v-if="clientinfo.client_loans">	{{clientinfo.client_loans.firstname}} 
                           	{{clientinfo.client_loans.middlename}} 	{{clientinfo.client_loans.lastname}}</template>
                      </td>
                     <td style="text-align:right; padding-right: 25px;">{{clientinfo.loanamountrequested }}</td>
        ...
        <button type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-info "
         @click="SaveClienttoviewdetails(clientinfo.clientname), vewClientloans(clientinfo)"> View Loans 
         </button> 
                           

          <button v-if="clientinfo.requeststate == 0" type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-success "
         @click="SaveClienttoviewdetails(clientinfo.clientname), approveLoanapplied(clientinfo)"> Approve Loan 
         </button> 
                                               </a>  
             <!--
<a href="#"><button type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-primary fas fa-edit " @click="editSubmenu(clientinfo)"> Edit </button> 
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                   <pagination :data="submenurecords" @pagination-change-page="paginationResultsSubmenus"></pagination>
                       ...
                       <div class="tab-pane p-3" id="messages1" role="tabpanel">
                                                        ...
                                                        <div class="bethapa-table-header">
                      Form Features
                      <button type="button"  class="add-newm" @click="newComponentfeaturesmodal" >Add New </button> 
                     </div>
     <table class="table">
                  <thead>
                    <tr>
...
<div
                        class="modal fade"
                        id="addnewcomponentfeaturemodal"
        ...
        <!-- <form @submit.prevent="SaveRoletoaddmainmenu()">     -->
                    ...
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">System Name</label>
                      <div class="col-sm-9">
...
<!-- end of componet features -->

<!-- vue components access  -->
<div
                        class="modal fade"
                        id="addnewvuecomponentmodal"
                           data-bs-backdrop="static"
                      data-bs-keyboard="false"
                        tabindex="-1"
                        aria-labelledby="bs-example-modal-lg"
...
<!-- start of component features -->


<div
                        class="modal fade"
                        id="addnewsubmenuModal"
                           data-bs-backdrop="static"
                      data-bs-keyboard="false"
                        tabindex="-1"
                        aria-labelledby="bs-example-modal-lg"
        ...
        <!-- <form @submit.prevent="SaveRoletoaddmainmenu()">     -->
                    ...
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Sub menu name</label>
                      <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Main Menu</label>
                      <div class="col-sm-9">
                        <select name ="type" v-model="form.mainheadercategory" id ="type" :class="{'is-invalid': form.errors.has('mainheadercategory')}" 
                        class="form-select"
                        >
                                        <option></option>
 ...
 <div class="mb-3 row">
   ...
   <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Display Order</label>
                      <div class="col-sm-9">
 ...
 <div
                      ...
                      data-bs-keyboard="false"
                        ...
                        aria-hidden="true"
                      >
                        <div class="modal-dialog modal-dialog-centered modal-xl animated disolve show">
                          <div class="modal-content">
                            <div class="modal-header d-flex align-items-center">
                              <h4 class="modal-title" id="myLargeModalLabel">
                            <div style= "tex-align:center">   Client Loan Details  </div>
                              </h4>
                              <button
                                type="button"
                                class="btn-close"
...
<table class="table customize-table mb-0 v-middle">
                  ...
                  <tbody>
                    <tr>
                       ...
                       <tr v-for="clientinfo in ncssloandetailsforclient.data" :key="clientinfo.id">
                                                  
                    <!-- <td>{{clientinfo.id}}</td> -->
                    
                     <!-- <td>{{clientinfo.firstname}} {{clientinfo.middlename}} {{clientinfo.lastname}}</td> -->
                      <!-- <td>
                         <template v-if="clientinfo.maincomponent_submenus">	{{clientinfo.maincomponent_submenus.mainmenuname}}</template>

                       
                      </td> -->
                     <td>{{clientinfo.accountnumber  }}</td>
            
                     <td style="text-align:center">{{clientinfo.loandate}}</td>
                   
                       <td style="text-align:right"> {{currencydetails}}{{formatPrice(( (clientinfo.loanamount ) ))}}</td>
                         <td style="text-align:center">{{clientinfo.interestrate  }}</td>
                    <td style="text-align:right"> {{currencydetails}}{{formatPrice(( (clientinfo.installmentamount )  ))}}</td>
                  
                     <td style="text-align:right"> {{currencydetails}}{{formatPrice(( (clientinfo.totalreturn ) ))}}</td>
              ...
              <button type="button" class="btn btn-light-danger text-danger font-weight-medium waves-effect text-start " data-bs-dismiss="modal" >
                      ...
                      data-bs-keyboard="false"
                        ...
                        aria-hidden="true"
                      >
                        <div class="modal-dialog modal-dialog-centered modal-xl animated flipInY show">
                          <div class="modal-content">
                            <div class="modal-header d-flex align-items-center">
                              <h4 class="modal-title" id="myLargeModalLabel">
                            <div style= "tex-align:center">    CLIENT INFORMATION  </div>
                              </h4>
                              <button
                                type="button"
                                class="btn-close"
 ...
 <div class="table-responsive">
     <div style="align:center;">
              ...
              <table class="table table-sm mb-0 v-middle">
               <thead style="background: #262b34;">
                  <tr>
                    <th colspan="2" >Client Information
</th>
                   <th colspan="2" style="text-align:right" >ACCOUNT INFORMATION
</th>
                ...
                <tbody>
                    ...
                    <td>Client Number </td>
                      ...
                      <td >{{clientnumberinquestion}}</td>
                      
                      <td  style="text-align:right"> Account Number</td>
                   
                      <td style="text-align:right">{{clientaccountnumberinquestion}}</td>
                    </tr>
                    ...
                    <td>Name </td>
                      ...
                      <td>{{clientnameinquestion}}</td>
                      <!-- background-color:rgb(48 37 37); -->
                      <td style="color:#8c682d; font-weight: bold;  font-size: 22px; text-align: right;" 
                      colspan="2">Loans Summary</td>
                 ...
                 <tr>
                    ...
                    <td>ID Type </td>
                      ...
                      <td> {{clientidtypeinquestion}} </td>
                      
                         <td  style="text-align:right"> Total Number of Loans Recieved</td>
                   
                      <td style="text-align:right">{{clienttotalnumberofloansinquestion}}</td>
                    </tr>

                     <tr>
                    <td>ID Number </td>
                   
                      <td>{{clientidnumberinquestion}}</td>

    <td  style="text-align:right"> Total Amount of Loans Recieved</td>
                   
                      <td style="text-align:right">{{clienttotalamountofloansinquestion}}</td>

                             </tr>
                <tr>
                    <td>Residence </td>
                
                      <td>{{clientresidenseinquestion}}</td>


                        <td  style="text-align:right"> Total Amount Loan Retrun</td>
                   
                      <td style="text-align:right">{{clienttotalamountofloanstoreturn}}</td>
                             </tr>
                    ...
                    <td>Contact </td>
                      ...
                      <td> {{clientprimarycontactinquestion}}</td>


                         <td  style="text-align:right"> Total Payment Recieved</td>
                   
                      <td style="text-align:right">{{clienttotalamountofloanspaidinquestion}}</td>
                             </tr>

                              <tr>
                    <td>Joined </td>
                    
                      <td>{{clientdatejoinedinquestion}}</td>
   <td  style="text-align:right"> Current Outstanding </td>
                   
                      <td style="text-align:right">{{clienttotalloanbalanceinquestion}}</td>
       ...
       <tr>
         ...
         <tr>
                     ...
                     <td style="color:#8c682d; background-color:rgb(48 37 37); font-weight: bold;  font-size: 22px; text-align: left;" 
                      colspan="2">Next of Kin Detail</td>
                        
                            <td  style="text-align:right"> Total  Deposits</td>
                   
                      <td style="text-align:right">{{clienttotalsavingsmadeinquestion}}</td>
                    ...
                    <td> {{clientnoknameinquestion}}</td>
                      

                       <td  style="text-align:right"> Total Deposited</td>
                   
                      <td style="text-align:right">{{clienttotalamountofsavingsinquestion}}</td>
  ...
  <tr>
                    ...
                    <td>Contact </td>
                      ...
                      <td>{{clientnokcontactinquestion}}</td>
                      <!-- background-color:rgb(48 37 37); -->


                        <td  style="text-align:right"> Total Withdraws</td>
                   
                      <td style="text-align:right">{{clienttotalamountwithdrawninquestion}}</td>
  ...
  <tr>
                    ...
                    <td>Residence </td>
                      ...
                      <td> {{clientnokresidenceinquestion}}</td>
                      <!-- background-color:rgb(48 37 37); -->
                         <td  style="text-align:right"> Available Balance</td>
                   
                      <td style="text-align:right">{{clienttotalamountofsavingsinquestion-clienttotalamountwithdrawninquestion}}</td>
              ...
              <tr>
                    ...
                    <td>Customer relationship </td>
                      ...
                      <td> {{clientnokrelationshipinquestion}}</td>
                      <!-- background-color:rgb(48 37 37); -->
...
<div
                      ...
                      >
                        <div class="modal-dialog modal-xl">
                          ...
                          Client Loan Application 
                                  ...
                                  <h4  v-show="editmode" class="modal-title" >Loan Confirmation</h4> 
                             <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <!-- <div class="modal-body"> -->
           
             <form class="form-control-line mt-4"  @submit.prevent="editmode ? confirmLoanapplication():createNewloanapplication()"> 

           
           
                           <div class="card-body">
                    <div v-show="!editmode" class="bethapa-table-sectionheader">Loan details</div>
                    <div v-show="editmode" class="bethapa-table-sectionheader">Pre - Loan Application Details</div>
  <form @submit.prevent="savenewRecordtoview()">    
                   
                    <div class="mb-3 row" v-show="!editmode">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Country : </label>
                      <div class="col-sm-9">
                     <has-error :form="form" field="countryname"></has-error>
                                               <select name ="countryname" v-model="form.countryname"  
  ...
  <div class="mb-3 row" v-show="editmode">
                      ...
                      <div class="col-sm-9">
                     <has-error :form="form" field="countryname"></has-error>
                                               <select disabled name ="countryname" v-model="form.countryname"  
                                                 id ="countryname"
                   ...
                   <div class="mb-3 row" v-show="!editmode">
                      ...
                      <div class="col-sm-9">
                         <has-error :form="form" field="companyname"></has-error>
                                               <select name ="companyname" v-model="form.companyname"
                                               v-on:change="myClickEventtosavesalesreportbydatehhhhhhhhhh" @change='getCompanyactiveclients();
                                                getcompanybranches();getcompanyemployees(); getloansecurities();'
                      ...
                      <div class="col-sm-9">
                         <has-error :form="form" field="companyname"></has-error>
                                               <select name ="companyname" v-model="form.companyname"
                                                ...
                                                id ="companyname" disabled :class="{'is-invalid': form.errors.has('companyname')}"
                                      class="form-control form-control-line">
                                        <option></option>
                                        <option v-for='data in generalcompanieslist' :value='data.id'>{{ data.companyname }}</option>
                                    </select>
                                      <has-error :form="form" field="companyname"></has-error>
                      </div>
                    </div>
                           ...
                           <div class="mb-3 row" v-show="!editmode">
                      <label class="col-sm-3 text-end control-label col-form-label">Client : </label>
                      <div class="col-sm-9">
                         <has-error :form="form" field="companyclients"></has-error>
                                               <select name ="companyclients" v-model="form.companyclients"
                                                v-on:change="myClickEventtosavesalesreportbydate"
                                               
                                                id ="companyclients" :class="{'is-invalid': form.errors.has('companyclients')}"
                                      class="form-control form-control-line">
                                        <option></option>
                                        <option v-for='data in companyactiveclients' :value='data.id'>{{ data.id }} - {{ data.firstname }} {{ data.middlename }} {{ data.lastname }}</option>
                                    </select>
                                      <has-error :form="form" field="companyclients"></has-error>
                      </div>
                    </div>
                      ...
                      <div class="col-sm-9">
                         <has-error :form="form" field="clientname"></has-error>
                                               <select disabled name ="clientname" v-model="form.clientname"
                                               
                                               
                                                id ="clientname " :class="{'is-invalid': form.errors.has('clientname')}"
                                      class="form-control form-control-line">
                                        <option></option>
                                        <option v-for='data in generalclientdetails' :value='data.id'>{{ data.id }} - {{ data.firstname }} {{ data.middlename }} {{ data.lastname }}</option>
                                    </select>
                                      <has-error :form="form" field="clientname"></has-error>
                      </div>
                    </div>
        ...
        <!-- <form @submit.prevent="SaveRoletoaddmainmenu()">     -->
                    ...
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Loan Amount :</label>
                      <div class="col-sm-9">
                      <input v-model="form.loanamountrequested" type="text" name="loanamountrequested"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('loanamountrequested') }">
                    <has-error :form="form" field="loanamountrequested"></has-error>
                      </div>
                    </div>

   <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Request Date</label>
                      <div class="col-sm-9">
                      <input v-model="form.requestdate" type="date" name="requestdate"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('requestdate') }">
                    <has-error :form="form" field="requestdate"></has-error>
                      </div>
                    </div>

 <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Expected Date : </label>
                      <div class="col-sm-9">
                      <input v-model="form.expecteddate" type="date" name="expecteddate"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('expecteddate') }">
                    <has-error :form="form" field="expecteddate"></has-error>
                      </div>
                    </div>

    <div class="mb-3 row" v-show="!editmode">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Loan Security :</label>
                      <div class="col-sm-9">
      <select name ="loansecurity" v-model="form.loansecurity"  
                                                id ="loansecurity"
                                               
                                                :class="{'is-invalid': form.errors.has('loansecurity')}"
                                     class="form-control form-control-line" >
                                        <option></option>
                                        <option v-for='data in loansecuritieslist' :value='data.id'>{{ data.securityname }}</option>
                                    </select>



                    <has-error :form="form" field="loansecurity"></has-error>
                     ...
                     <div class="mb-3 row" v-show="editmode">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Loan Security # :</label>
                      <div class="col-sm-9">
      <select name ="loansecurity" disabled v-model="form.loansecurity"  
                                                id ="loansecurity1"
                                               
                                                :class="{'is-invalid': form.errors.has('loansecurity')}"
                                     class="form-control form-control-line" >
                                        <option></option>
                                        <option v-for='data in generalloansecurities' :value='data.id'>{{ data.securityname }}</option>
                                    </select>
                      ...
                      <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Security Description : </label>
                      <div class="col-sm-9">
                   <textarea class="form-control"  v-model="form.securitydesciption" name="securitydesciption"
                    :class="{ 'is-invalid': form.errors.has('securitydesciption') }"
                    id="securitydesciption" rows="2" placeholder=""></textarea>

                    <has-error :form="form" field="securitydesciption"></has-error>
                      </div>
                    </div>
     ...
     <div class="mb-3 row" v-show="editmode">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Loan officer:</label>
                      <div class="col-sm-9">
                    
                   
   <select name ="loanofficername" disabled v-model="form.loanofficername"  
                                                id ="loanofficername"
                                               
                                                :class="{'is-invalid': form.errors.has('loanofficername')}"
                                     class="form-control form-control-line" >
                                        <option></option>
                                        <option v-for='data in generalloanofficers' :value='data.id'>{{ data.employeename }}</option>
                                    </select>



                    <has-error :form="form" field="loanofficername"></has-error>
                      </div>
                    </div>
   ...
   <select name ="loanofficername" v-model="form.loanofficername"  
                                                id ="loanofficername"
                                               
                                                :class="{'is-invalid': form.errors.has('loanofficername')}"
                                     class="form-control form-control-line" >
                                        <option></option>
                                        <option v-for='data in companyemployeelist' :value='data.id'>{{ data.employeename }}</option>
                                    </select>
...
<div class="mb-3 row" v-show="editmode">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Branch :</label>
                      <div class="col-sm-9">
                    
                    <!--  v-on:change="myClickEventtosavesalesreportbydate"  @change='getCountrycompanies()' -->
   <select name ="branchname" disabled v-model="form.branchname"  
                                                id ="branchname"
                                               
                                                :class="{'is-invalid': form.errors.has('branchname')}"
                                     class="form-control form-control-line" >
                                        <option></option>
                                        <option v-for='data in generalbranches' :value='data.id'>{{ data.branchname }}</option>
                                    </select>
...
<div class="mb-3 row" v-show="!editmode">
   ...
   <select name ="branchname" v-model="form.branchname"  
                    ...
                    <has-error :form="form" field="branchname"></has-error>
                     ...
                     <div v-show="editmode">
            <div v-show="editmode" class="bethapa-table-sectionheader">Approval Details</div>         
        
        
                <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Approved Amount :</label>
                      <div class="col-sm-9">
                      <input v-model="form.loanamount" type="text" name="loanamount"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('loanamount') }">
                    <has-error :form="form" field="loanamount"></has-error>
                      </div>
                    </div>

  <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Start Date of payment :</label>
                      <div class="col-sm-9">
                      <input v-model="form.startdateofpayment" type="date" name="startdateofpayment"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('startdateofpayment') }">
                    <has-error :form="form" field="startdateofpayment"></has-error>
                      </div>
                    </div>

                     <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Payment Plan :</label>
                      <div class="col-sm-9">
                    <select name ="paymentplan"  v-model="form.paymentplan"  
                                                id ="paymentplan"
                                               
                                                :class="{'is-invalid': form.errors.has('paymentplan')}"
                                     class="form-control form-control-line" >
                                        <option></option>
                                        <option v-for='data in companypaymentplanslist' :value='data.planname'>{{ data.planrealname }}</option>
                                    </select>

                    <has-error :form="form" field="paymentplan"></has-error>
                      </div>
                    </div>
 ...
 <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Intrest (%ge) :</label>
                      <div class="col-sm-9">
                      <input v-model="form.intrestrate" @keyup="calculatingthetotalintrest" @keypress="calculatingthetotalintrest" type="text" name="intrestrate"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('intrestrate') }">
                    <has-error :form="form" field="intrestrate"></has-error>
                      </div>
                    </div>

  <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Total interest:</label>
                      <div class="col-sm-9">
                      <input readonly v-model="form.totalinterest" type="text" name="totalinterest"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('totalinterest') }">
                    <has-error :form="form" field="totalinterest"></has-error>
                      </div>
                    </div>

   <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Payment Period (Months) :</label>
                      <div class="col-sm-9">
                      <input v-model="form.paymentperiod" type="number" name="paymentperiod"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('paymentperiod') }">
                    <has-error :form="form" field="paymentperiod"></has-error>
                      </div>
                    </div>
                    ...
                    <has-error :form="form" field="startdateofpayment"></has-error>
                     ...
                     <!-- <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Expected Return:</label>
                      <div class="col-sm-9">
                      <input readonly v-model="form.totalreturn" type="text" name="totalreturn"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('totalreturn') }">
                    <has-error :form="form" field="totalreturn"></has-error>
                      </div>
                    </div> -->
        ...
        <!-- </form> -->
          ...
          <div class="modal-footer">
             <button type="submit" v-show="!editmode" class="btn btn-info rounded-pill px-4 waves-effect waves-light "> Submit Application </button>
              <button type="submit" v-show="editmode" class="btn btn-info rounded-pill px-4 waves-effect waves-light "> Approve loan </button>
                              <button
                                type="button"
                                class="
                                  btn btn-light-danger
...
totalreturn: 0,
                ...
                companiesss:[],
                loanofficerslist:[],
                    companyactiveclients:[],
                    companybrancheslist:[],
                    companyemployeelist:[],
                    loansecuritieslist:[],
                    generalcompanieslist:[],
                    generalclientdetails:[],
                        generalloansecurities:[],
                        generalloanofficers:[],
                        generalbranches:[],
                        companypaymentplanslist:[],
mainmenulist:[],
            ///////////////////////////////////
          brancheslist: null,
...
clientnumberinquestion:'',
clientnameinquestion:'',
clientidtypeinquestion:'',
clientidnumberinquestion:'',
clientnokrelationshipinquestion:'',
clientprimarycontactinquestion:'',
clientresidenseinquestion:'',
clientdatejoinedinquestion:'',
clientnoknameinquestion:'',
clientstatusinquestion:'',
clientnokcontactinquestion:'',
clientnokresidenceinquestion:'',
clientaccountnumberinquestion:'',
clienttotalnumberofloansinquestion:'',
clienttotalamountofloansinquestion:'',
clienttotalamountofloanstoreturn:'',
clienttotalamountofloanspaidinquestion:'',
clienttotalloanbalanceinquestion:'',
clienttotalsavingsmadeinquestion:'',
clienttotalamountofsavingsinquestion:'',
clienttotalamountwithdrawninquestion:'',
clientavailablesavingsbalanceinquestion:'',
          ...
          submenurecords : {},
          ncsscleintrecords :{},
          ncssloandetailsforclient:{},
          ncssloansaccountrecords:{},
          ncssloansrecords:{},
...
methods:{
    approveLoanapplied(ncssloansrecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(ncssloansrecords);
$('#applyfornewLoanmodal').modal('show');
            },
   savenewRecordtoview(){
this.loading = true;
                           //     this.$Progress.start();
...
getCountrycompanies: function() {
   ...
   getcompanyemployees: function() {
                axios.get('/api/getcompanyemployees',{params: {companyemployees: this.companyemployees       }
              }).then(function(response){
                    this.companyemployeelist = response.data;
                }.bind(this));
            countryname.hide
        },
           getloansecurities: function() {
                axios.get('/api/getcompanysecurities',{params: {loansecurity: this.loansecurity       }
              }).then(function(response){
                    this.loansecuritieslist = response.data;
                }.bind(this));
            countryname.hide
        },
 ...
 getcompanybranches: function() {
        ...
        getCompanyactiveclients: function() {
                axios.get('/api/companyactiveclients',{params: {companyclients: this.companyclients       }
              }).then(function(response){
                    this.companyactiveclients = response.data;
                }.bind(this));
            countryname.hide
        },
        
   gegeneralclientdetails: function(){ axios.get('/api/generalclientdetails').then(function (response) { this.generalclientdetails = response.data;}.bind(this));},

 getpaymentplanslist: function(){ axios.get('/api/companypaymentplanslist')
   .then(function (response) { this.companypaymentplanslist = response.data;}.bind(this));},


 getgeneralbranches: function(){ axios.get('/api/generalbranches')
   .then(function (response) { this.generalbranches = response.data;}.bind(this));},



  getgeneralloanofficers: function(){ axios.get('/api/generalloanofficers')
   .then(function (response) { this.generalloanofficers = response.data;}.bind(this));},



   getgeneralloansecurities: function(){ axios.get('/api/getgeneralloansecurities')
   .then(function (response) { this.generalloansecurities = response.data;}.bind(this));},

   getgeneralcompanieslist: function(){ axios.get('/api/getcompaniesdetails').then(function (response) { this.generalcompanieslist = response.data;}.bind(this));},
...
getClientloansaccount (){ 
   
     axios.get("api/ncssloansaccountrecords").then(({ data }) => (this.ncssloansaccountrecords = data));
            },
loadClientloans (){ 
   
     axios.get("api/ncssloansrecords").then(({ data }) => (this.ncssloansrecords = data));
            },

            

              
getloandetailsforClient (){ axios.get("api/ncssloandetailsforclient").then(({ data }) => (this.ncssloandetailsforclient = data)); },


getncssclientrecords (){ 
   
     axios.get("api/ncsscleintrecords").then(({ data }) => (this.ncsscleintrecords = data));
            },
...
SaveClienttoviewdetails(id){
this.form.delete('api/saveclienttoviedetails/'+id);               
axios.get("api/clientnumberinquestion").then(({ data }) => (this.clientnumberinquestion = data));
axios.get("api/clientnameinquestion").then(({ data }) => (this.clientnameinquestion = data));
axios.get("api/clientidtypeinquestion").then(({ data }) => (this.clientidtypeinquestion = data));
axios.get("api/clientidnumberinquestion").then(({ data }) => (this.clientidnumberinquestion = data));
axios.get("api/clientresidenseinquestion").then(({ data }) => (this.clientresidenseinquestion = data));
axios.get("api/clientcontactinquestion").then(({ data }) => (this.clientcontactinquestion = data));
axios.get("api/clientdatejoinedinquestion").then(({ data }) => (this.clientdatejoinedinquestion = data));
axios.get("api/clientstatusinquestion").then(({ data }) => (this.clientstatusinquestion = data));
axios.get("api/clientnoknameinquestion").then(({ data }) => (this.clientnoknameinquestion = data));
axios.get("api/clientnokcontactinquestion").then(({ data }) => (this.clientnokcontactinquestion = data));
axios.get("api/clientnokresidenceinquestion").then(({ data }) => (this.clientnokresidenceinquestion = data));
axios.get("api/clientnokrelationshipinquestion").then(({ data }) => (this.clientnokrelationshipinquestion = data));
axios.get("api/clientaccountnumberinquestion").then(({ data }) => (this.clientaccountnumberinquestion = data));
axios.get("api/clienttotalnumberofloansinquestion").then(({ data }) => (this.clienttotalnumberofloansinquestion = data));
axios.get("api/clienttotalamountofloansinquestion").then(({ data }) => (this.clienttotalamountofloansinquestion = data));
axios.get("api/clienttotalamountofloanstoreturn").then(({ data }) => (this.clienttotalamountofloanstoreturn = data));


axios.get("api/clienttotalamountofloanspaidinquestion").then(({ data }) => (this.clienttotalamountofloanspaidinquestion = data));
axios.get("api/clienttotalloanbalanceinquestion").then(({ data }) => (this.clienttotalloanbalanceinquestion = data));
axios.get("api/clienttotalsavingsmadeinquestion").then(({ data }) => (this.clienttotalsavingsmadeinquestion = data));
axios.get("api/clienttotalamountofsavingsinquestion").then(({ data }) => (this.clienttotalamountofsavingsinquestion = data));
axios.get("api/clienttotalamountwithdrawninquestion").then(({ data }) => (this.clienttotalamountwithdrawninquestion = data));
axios.get("api/clientavailablesavingsbalanceinquestion").then(({ data }) => (this.clientavailablesavingsbalanceinquestion = data));
axios.get("api/clientprimarycontactinquestion").then(({ data }) => (this.clientprimarycontactinquestion = data));
this.getloandetailsforClient();
            },
...
loadloanofficers(){  axios.get("api/loanofficerslist").then(({ data }) => (this.loanofficerslist = data)); },
 loadidtypes(){  axios.get("api/idtypeslist").then(({ data }) => (this.idtypeslist = data)); },
 loadbranches(){  axios.get("api/brancheslist").then(({ data }) => (this.brancheslist = data)); },
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// Start of Sub menus
  ...
  loadSubmenus(){
    ...
    vewClientloans(mainmenurecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(mainmenurecords);
$('#clientLoans').modal('show');
            },
           
  viewClientdetails(mainmenurecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(mainmenurecords);
...
$('#applyfornewLoanmodal').modal('show');
  ...
  createNewloanapplication(){
      this.$Progress.start();
        this.form.post('api/newloanapplication')
        .then(()=>{
 this.form.reset();
         
    $('#applyfornewLoanmodal').modal('hide');
    this.getncssclientrecords();
    Fire.$emit('AfterAction');
  ...
  title: 'Record added successfully'
    ...
    createNewclient(){
      this.$Progress.start();
        this.form.post('api/newclientregistration')
        .then(()=>{
...
this.form.put('api/newloanapplication/'+this.form.id)
  .then(()=> {
    // on success
   $('#applyfornewLoanmodal').modal('hide');
    Swal.fire(
...
//////////////////////////////////////////////////////// End of main menu
     ...
     axios.get("api/mainmenuaccessComponent").then(({ data }) => (this.mainmenuaccessComponent = data));
          ...
          //  , totalinterest totalreturn
              calculatingthetotalintrest(event) {
        this.form.intrestrate = event.target.value
        this.form.totalinterest = ((this.form.intrestrate)/100) * (this.form.loanamount)
        //  this.form.totalreturn = ((this.form.totalinterest.this.form.loanamount))
      },
...
///////////////////////////////////////////////////
        created() {
          ...
          this.getgeneralbranches();
          this.getgeneralloanofficers();
          this.getgeneralloansecurities();
          this.gegeneralclientdetails();
          this.getgeneralcompanieslist();
          this.loadloanofficers();
          this.getcountries();
          this.getClientloansaccount();
          this.loadidtypes();
          this.loadbranches();
     axios.get("api/submenuaccessComponent").then(({ data }) => (this.submenuaccessComponent = data));
