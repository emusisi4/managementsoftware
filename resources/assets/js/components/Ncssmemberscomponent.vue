...
<div class="col-md-12">
              <div class="card">
                <div class="d-flex  border-bottom title-part-padding align-items-center ">
                  <div>
                    <h2 class="card-title mb-0"> CLIENTS AND EMPLOYEES INFORMATION</h2>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab"  @click="getncssclientrecords()" href="#home" role="tab">
                          <span>Clients</span>
                        </a>
                      </li>
                      <li class="nav-item">
                      ...
                      getcountries: function(){ axios.get('/api/getCountries').then(function (response) { this.countrieslist = response.data;}.bind(this));},
                       -->
                        ...
                        <!-- <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab"  @click="getcountries()" href="#messages1" role="tab">
                          <span>Form / Component Features</span>
                        </a>
                      </li> -->
                    ...
                    Client Details <button  type="button" class="add-newm"  @click="newMainmenumodal" >Add New </button>
                     </div>
...
<div class="card">
            ...
            <table class="table customize-table mb-0 v-middle">
                  ...
                  <tbody>
                    <tr>
                       ...
                       <tr v-for="clientinfo in ncsscleintrecords.data" :key="clientinfo.id">
                    ...
                    <td>{{clientinfo.id}}</td>
                     ...
                     <td>{{clientinfo.clientidno  }}</td>
            
                     <td>{{clientinfo.primarycontact}}</td>
                     <td>{{clientinfo.clientresidence  }}</td>
                         <!-- <td>{{clientinfo.datejoined  }}</td> -->
                    <!-- <td>{{clientinfo.nokname  }}</td>
                     <td>{{clientinfo.nokcontactone}}</td>
                    -->
         ...
         <button type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-info " @click="SaveClienttoviewdetails(clientinfo.id), viewClientdetails(clientinfo)"> View Details </button> 
                                              </a>  
...
<div
             ...
             <form class="form-control-line mt-4"  @submit.prevent="editmode ? updateMainmenu():createNewclient()"> 

           
           
                           <div class="card-body">
                    <div class="bethapa-table-sectionheader">CLIENTS INFORMATION</div>
                 <!-- <form @submit.prevent="savenewRecordtoview()">    
   ...
   <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Middle Name : </label>
                      <div class="col-sm-9">
 ...
 <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Contact Number #1 :</label>
                      <div class="col-sm-9">
                      <input v-model="form.primarycontact" type="text" name="primarycontact"
                    ...
                    <!-- <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Contact Number #2 :</label>
                      <div class="col-sm-9">
                      <input v-model="form.secondarycontact" type="text" name="secondarycontact"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('secondarycontact') }">
                    <has-error :form="form" field="secondarycontact"></has-error>
                      </div>
                    </div> -->

   <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Residence :</label>
                      <div class="col-sm-9">
                      <input v-model="form.clientresidence" type="text" name="clientresidence"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('clientresidence') }">
                    <has-error :form="form" field="clientresidence"></has-error>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">ID Type :</label>
                      <div class="col-sm-9">
                    
                    <!--  v-on:change="myClickEventtosavesalesreportbydate" -->
   <select name ="clientidnature" v-model="form.clientidnature"  
                                                id ="clientidnature"
                                                
                                                :class="{'is-invalid': form.errors.has('clientidnature')}"
                                     class="form-control form-control-line" >
                                        <option></option>
                                        <option v-for='data in idtypeslist' :value='data.id'>{{ data.idtypename }}</option>
                                    </select>



                    <has-error :form="form" field="clientidnature"></has-error>
                      </div>
                    </div>
                 ...
                 <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">ID NUMBER :</label>
                      <div class="col-sm-9">
                      <input v-model="form.clientidno" type="text" name="clientidno"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('clientidno') }">
                    <has-error :form="form" field="clientidno"></has-error>
                      </div>
                    </div>

<div v-if="loidtypeerror == '1'">
   <form @submit.prevent="savenewRecordtoview()">    
             ...
             <button type="submit" id="submit" hidden="hidden" name= "submit" ref="theButtontosabemonthlyreportviePOOOJJJ" class="btn btn-primary btn-sm">Saveit</button>         
                           ...
                           <!-- closing if super admin -->

                      <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Date of Membership :</label>
                      <div class="col-sm-9">
                      <input v-model="form.datejoined" type="date" name="datejoined"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('datejoined') }">
                    <has-error :form="form" field="datejoined"></has-error>
                      </div>
                    </div>
<div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Membership Branch :</label>
                      <div class="col-sm-9">
 ...
 <div class="bethapa-table-sectionheader">Employment Details</div>
  <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label"> Employment :</label>
                      <div class="col-sm-9">
                      <input v-model="form.clientemployment" type="text" name="clientemployment"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('clientemployment') }">
                    <has-error :form="form" field="clientemployment"></has-error>
                      </div>
                    </div>
...
<div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Employment location :</label>
                      <div class="col-sm-9">
                      <input v-model="form.employmentlocation" type="text" name="employmentlocation"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('employmentlocation') }">
                    <has-error :form="form" field="employmentlocation"></has-error>
                      </div>
                    </div>

   
<div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Employer name :</label>
                      <div class="col-sm-9">
                      <input v-model="form.nameofempployer" type="text" name="nameofempployer"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('nameofempployer') }">
                    <has-error :form="form" field="nameofempployer"></has-error>
                      </div>
                    </div>
...
<div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Employer Contact :</label>
                      <div class="col-sm-9">
                      <input v-model="form.employerconctact" type="text" name="employerconctact"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('employerconctact') }">
                    <has-error :form="form" field="employerconctact"></has-error>
                      </div>
                    </div>



 <div class="bethapa-table-sectionheader">Next of Kin DEtails</div>
   <div class="mb-3 row">
                      <label for="nokname" class="col-sm-3 text-end control-label col-form-label">Full Name :</label>
                      <div class="col-sm-9">
                      <input v-model="form.nokname" type="text" name="nokname"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('nokname') }">
                    <has-error :form="form" field="nokname"></has-error>
                      </div>
                    </div>

 <div class="mb-3 row">
                      <label for="nokcontactone" class="col-sm-3 text-end control-label col-form-label">Contact :</label>
                      <div class="col-sm-9">
                      <input v-model="form.nokcontactone" type="text" name="nokcontactone"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('nokcontactone') }">
                    <has-error :form="form" field="nokcontactone"></has-error>
                      </div>
                    </div>
<div class="mb-3 row">
                      <label for="nokresidence" class="col-sm-3 text-end control-label col-form-label">Relationship :</label>
                      <div class="col-sm-9">
                      <input v-model="form.nokresidence" type="text" name="nokresidence"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('nokresidence') }">
                    <has-error :form="form" field="nokresidence"></has-error>
                      </div>
                    </div>
                   <div class="mb-3 row">
                      <label for="nokrelationship" class="col-sm-3 text-end control-label col-form-label">Residence :</label>
                      <div class="col-sm-9">
                      <input v-model="form.nokrelationship" type="text" name="nokrelationship"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('nokrelationship') }">
                    <has-error :form="form" field="nokrelationship"></has-error>
                      </div>
                    </div>
...
getncssclientrecords (){ 
  ...
  loggedinuserType: function(){ axios.get('/api/getRoles').then(function (response) { this.roleslist = response.data;}.bind(this));},
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// Start of Sub menus
  ...
  loadSubmenus(){
   ...
   loiddVolids(){
     ...
     axios.get("api/loidtypeerror").then(({ data }) => (this.loidtypeerror = data));
     axios.get("api/loidrerror").then(({ data }) => (this.loidrerror = data));
