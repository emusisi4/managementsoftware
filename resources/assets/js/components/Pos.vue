...
<!-- <div v-if="isthereclosingstock < 1">

 <div class="modssal" id="">
         <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            <h3 style="color: #ff0022;"   class="modal-title"><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">SHIFT NOT CLOSED</h3> 
                  ...
                  <form>
                           ...
                           <h4 style="text-align: center;">Please yesterday's shift was not Closed</h4> 
       
                                
                           <h4 style="text-align: center;">Please close the shift by clicking on the confirmation box to proceed</h4> 
                  ...
                  <div  class="modal-footer">
                      ...
                      <button   @click="confirmupdatestockvalue"  type="submit" class="btn btn-info btn-sm" >Close Shift</button>
  ...
  <!-- <div v-if="isthereclosingstock > 0"> -->
    <div>
 <div>
...
<!-- v-if="netvatvatcomponentcomponentaccess > 0" -->
 ...
 <section >
   <!-- cheching for the closing stock -->
...
<table style="width:100%">
 ...
 <!-- closing if there is isthereclosingstock -->
...
axios.get("api/isthereclosingstock").then(({ data }) => (this.isthereclosingstock = data));
...
paginationroleAuthorisedsubmenues(page = 1) {
  ...
  confirmupdatestockvalue(id){
   Swal.fire({
  title: 'CLOSING SHIFT',
  text: "You are closing the open shift in order to sttart a new shift",
  icon: 'warning',
  showCancelButton: true,
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
...
/// send request ti
if (result.isConfirmed) {
   this.form.post('api/shitclosing').then(()=>{
