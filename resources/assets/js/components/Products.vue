         ...
         <div class="modal-dialog modal-lg">
           <div class="modal-content" >
                    <!-- <div class="modal-content" style="width:1500px"> -->
                        <div class="modal-header">
                            <h3  v-show="!editmode"    class="modal-title"><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">
                            Invoice Details </h3> 
                <h4  v-show="editmode" class="modal-title" ><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">Update Record </h4> 
                        </div>
...
<!-- v-if="purcdet.status == '0'" -->
                                 
                                 </td>
                              
<td><button  v-if="purcdet.status == '1' " type="button" class="btn bg-deep-orange btn-xs waves-effect"
                   @click="deletePurchaseddelivereditem(purcdet.id)">Del</button>
</td>
       ...
       <tr>
            ...
            <th colspan="1"  style="font-size: 18px; text-align:center;    
             ...
             <th colspan="1"  style="font-size: 18px;   text-align:center;  border-bottom: 4px solid rgb(124 102 102); 
               ...
               <th colspan="4"  style="font-size: 18px; text-align:center;    
               border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"> Delivery Detailns</th>
    <th colspan="1"  style="font-size: 18px; text-align:center;    
...
deletePurchaseddelivereditem(id){
   Swal.fire({
  title: 'Are you sure?',
...
/// send request ti
if (result.isConfirmed) {
  this.form.delete('api/deleteconfirmedpurchaserecord/'+id).then(()=>{
