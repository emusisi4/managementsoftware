                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active" >
                                    <a href="#company_details_tab" @click="getShopbalancingrecords()" data-toggle="tab">
                                        <i class="material-icons"></i>Shop Balancing
                                    </a>
                                </li>

                                <li role="presentation" >
                                    <a href="#home_with_icon_title" @click="loadfishcollectionrecords()" data-toggle="tab">
                                        <i class="material-icons"></i>Cash Collections
                                    </a>
                                </li>
                                ...
                                <li role="presentation">
                                    <a href="#profile_with_icon_title" @click="loadfishcreditsrecords()" data-toggle="tab">
                                        <i class="material-icons"></i> Cash Credits
                                    </a>
                                </li>
 <li role="presentation" >
                                    <a href="#messages_with_icon_title" data-toggle="tab"  @click="loadBranchstandingaccounts()">
                                        <i class="material-icons"></i> Branch Standings
                                    </a>
                                </li>
...
<option v-for='data in brancheslist' v-bind:value='data.id'> {{ data.branchname }}</option>
            ...
            <has-error :form="form" field="branchname"></has-error>
             ...
             <button type="submit" id="submit" style="display:none;" hidden="hidden" name= "submit" ref="theButtontotosalesreportmonthly" class="btn btn-primary btn-sm">Saveit</button>         
...
<th colspan="5"  style="text-align:center;  background-color: green; color:#eee   "> <b>ALL PRODUCTS SUMMARY ({{currencydetails}} )</b></th>
                     


                     <!-- v-if=" fishgameproduct > 0  " -->
<th colspan="5"  style="text-align:center;  background-color: #9a6d1b; color:#eee   ">FISH ({{currencydetails}} ) </th>
                   
                    <!-- v-if=" virtualgameproduct > 0  " -->
<th colspan="5"   style="text-align:center;  background-color: #90423c;color:#eee "> VIRTUAL ({{currencydetails}} )</th>
               ...
               <tr v-for="shobalrecs in shopbalancingdatarecords.data" :key="shobalrecs.id">        
                                ...
                                <td>{{shobalrecs.id}}</td>
                                 <td>{{shobalrecs.datedone}}</td>
                                   ...
                                   <td style="text-align:right;">{{formatPrice(shobalrecs.totalsales)}}</td>
                                   
                                      <td style="text-align:right;"> {{formatPrice(shobalrecs.totalpayout)}}</td>

<td style="text-align:center;">
                                                   
                                          <div v-if="(shobalrecs.totalsales)  == 0 "> - </div> 
<div v-if="(shobalrecs.totalsales-shobalrecs.totalcancelled)  != 0 ">
    {{parseFloat(((shobalrecs.totalpayout) /(shobalrecs.totalsales))*100).toFixed(0)}}%
</div> </td>




                                      <td style="text-align:right;">{{formatPrice(shobalrecs.totalprofit)}}
                                           </td>
  ...
  <div  v-if="(shobalrecs.totalsales-shobalrecs.totalcancelled) !=0 ">
     {{parseFloat(((shobalrecs.totalprofit) /(shobalrecs.totalsales))*100).toFixed(0)}}% </div>
                    ...
                    <td style="text-align:right;">{{formatPrice((shobalrecs.fishpayout)*shobalrecs.multiplier)}}</td>
                     ...
                     <td style="text-align:right;" >{{formatPrice((shobalrecs.fishincome))}}  </td>
                      ...
                      <td style="text-align:center;"> 
                         ...
                         <td style="text-align:right;"  >{{formatPrice(shobalrecs.vsales)}}</td>
                     
                       <td style="text-align:right;" >{{formatPrice(shobalrecs.vpay)}}</td>
         <td style="text-align:center; ">
           ...
           <div v-if="(shobalrecs.vsales-shobalrecs.vcan) == 0">- </div>
                                     ...
                                     <td style="text-align:right;" >{{formatPrice((shobalrecs.vprof))}}</td>
...
<td style="text-align:center; " >
  ...
  <div v-if="(shobalrecs.vsales-shobalrecs.vcan) == 0"> - </div>
                                    ...
                                    <!-- <td style="text-align:right;" >{{formatPrice((shobalrecs.cashin))}}</td>
                     <td style="text-align:right;" >{{formatPrice((shobalrecs.cashout))}}</td>
                    -->
...
<option v-for='data in brancheslist' v-bind:value='data.id'> {{ data.branchname }}</option>
            ...
            <has-error :form="form" field="branchname"></has-error>
             ...
             <button type="submit" id="submit" style="display:none;" hidden="hidden" name= "submit" ref="theButtontotosalesreportmonthly2" class="btn btn-primary btn-sm">Saveit</button>         
...
<option v-for='data in brancheslist' v-bind:value='data.id'> {{ data.branchname }}</option>
            ...
            <has-error :form="form" field="branchname"></has-error>
             ...
             <button type="submit" id="submit" style="display:none;" hidden="hidden" name= "submit" ref="theButtontotosalesreportmonthly3" class="btn btn-primary btn-sm">Saveit</button>         
 ...
 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               <has-error :form="form" field="branchname"></has-error>
                                               <select name ="type" v-model="form.branchname" v-on:mouseout ="myClickEventsavennn" v-on:change="myClickEventsavennn"
                                                id ="branchname" :class="{'is-invalid': form.errors.has('branchname')}"
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               ...
                                               <select name ="type" v-model="form.countryname"  v-on:change="myClickEventsavennn"
                                                id ="countryname" :class="{'is-invalid': form.errors.has('countryname')}"
                                      class="form-control show-tick" data-live-search="true">
                                        <option></option>
                                        <option v-for='data in countrieslist' :value='data.id'>{{ data.countryname }}</option>
                                    </select>
...
<div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               ...
                                               v-model="form.companyname"  v-on:change="myClickEventsavennn" id ="companyname" 
 ...
 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <has-error :form="form" field="datedone"  v-on:change="myClickEventsavennn"></has-error>
 ...
 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               <has-error :form="form" field="countryname"></has-error>
                                               <select name ="countryname" v-model="form.countryname" v-on:change="myClicktoaddcompanyinaction();  getcompanies();"  id ="countryname" :class="{'is-invalid': form.errors.has('countryname')}"
                                      class="form-control show-tick" data-live-search="true">
                                        <option></option>
                                        <option v-for='data in countrieslist' :value='data.id'>{{ data.countryname }}</option>
                                    </select>
   ...
   <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                      ...
                                      class="form-control show-tick" data-live-search="true">
                                        <option></option>
                                        <option v-for='data in walletlist' :value='data.walletno'>{{ data.name }}</option>
                                    </select>
...
myClickEventtosavemonthlyreportallbranches2($event) { const elem = this.$refs.theButtontotosalesreportmonthly2
        ...
        myClickEventtosavemonthlyreportallbranches3($event) { const elem = this.$refs.theButtontotosalesreportmonthly3
            elem.click()
        },
