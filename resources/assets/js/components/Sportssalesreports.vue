...
<div class="card">
   ...
   <div style="    font-size: 3.125rem;  text-align: center; font-weight: bold;">SALES REPORTS </div>
      ...
      <input v-model="form.enddate" type="date" name="enddate"  v-on:change="myClickEventtosavedates" :class="{ 'is-invalid': form.errors.has('enddate') }">
  ...
  <button type="submit"  style="display:none" id="submit" hidden="hidden" name= "submit" ref="myBtntosavedates" class="btn btn-primary btn-sm">Saveit</button>
                      ...
                      Daily Sales Report :  Start : {{ seleceteddatefordailyreport|myDate2 }} End : {{ seleceteddatefordailyreportenddate|myDate2 }}</i>
    ...
    <thead>
        <tr>
            <th rowspan="1" style="font-size: 30px; background-color: #272b34; "></th>
            <th rowspan="1" style="font-size: 30px; background-color: #272b34; "></th>
              <th colspan="5"  style="font-size: 30px; background-color: green; color:white; text-align: center; "> TOTAL ({{currencydetails}} )</th>
            <th colspan="5" style="font-size: 30px; background-color: orange; color:white; text-align: center; ">FISH ({{currencydetails}} ) </th>
            <th colspan="6"  style="font-size: 30px; background-color: maroon; color:white; text-align: center; ">VIRTUAL ({{currencydetails}} )</th>
    ...
    <tbody>
      ...
      <td  style="background-color: #32773280; text-align: right; ">  {{formatPrice(( (mydataObjectinfo.totalsales )  ))}} </td>
     
      <td style="background-color: #32773280; text-align: right;"> {{formatPrice((mydataObjectinfo.totalpayout))}} </td>
         
         


 <td style="background-color: #32773280;     text-align: center;" >
...
<td style="background-color: #32773280;     text-align: right; "> {{formatPrice(mydataObjectinfo.totalprofit)}} </td>    
<td style="background-color: #32773280;     text-align: center; ">
  <div v-if="(mydataObjectinfo.totalsales) == 0 " > -  </div>
  <div v-if="(mydataObjectinfo.totalsales) != 0 " >
  ...
  <td style="background-color: rgb(250 166 48 / 22%); text-align: right;"> {{formatPrice((mydataObjectinfo.salesamount))}} </td>
  <td style="background-color: rgb(250 166 48 / 22%);  text-align: right;" > {{formatPrice((mydataObjectinfo.payoutamount))}} </td>
  
  <td style="background-color: rgb(250 166 48 / 22%);text-align: center; ">{{parseFloat(((mydataObjectinfo.payoutamount) /(mydataObjectinfo.salesamount))*100).toFixed(0)}}% </td>
  <td style="background-color: rgb(250 166 48 / 22%); text-align: right; "> {{formatPrice((mydataObjectinfo.salesamount - mydataObjectinfo.payoutamount))}} </td>
  <td style="background-color: rgb(250 166 48 / 22%); text-align: center; " >{{parseFloat(((mydataObjectinfo.salesamount - mydataObjectinfo.payoutamount) /(mydataObjectinfo.salesamount))*100).toFixed(0)}}% </td>



                         <!-- ssssssssssssssssssssssssssssssssssssssssss  -->
     <td style="background-color: #80000069; text-align: right;"> {{formatPrice((mydataObjectinfo.virtualsales))}} </td>
      <!-- <td style="background-color: #80000069; ">  {{formatPrice((mydataObjectinfo.virtualcancelled))}} </td> -->
      <td style="background-color: #80000069; text-align: right;"> {{formatPrice((mydataObjectinfo.virtualpayout))}} </td>
 ...
 <td style="background-color: #80000069; text-align: center; ">
 ...
 <td style="background-color: #80000069; text-align: right;" >
   <div v-if="mydataObjectinfo.virtualpayout == 0 "> - </div>
      <div v-if="mydataObjectinfo.virtualpayout != 0 ">  
          {{formatPrice((mydataObjectinfo.virtualsales - mydataObjectinfo.virtualcancelled - mydataObjectinfo.virtualpayout))}}
 ...
 <td style="background-color: #80000069;  text-align: center;" >
   ...
   {{parseFloat(((mydataObjectinfo.virtualprofit) / (mydataObjectinfo.virtualsales-mydataObjectinfo.virtualcancelled) )*100).toFixed(0)}}%
    ...
    <div v-if="mydataObjectinfo.virtualprofit == 0 "> -  </div>
                      ...
                      <div class="form-group">
                    <label for="exampleInputEmail1">From :</label>
                    <input v-model="form.startdate" type="date" name="startdate"  v-on:change="myClickEventtosavesalesreportbydate"  :class="{ 'is-invalid': form.errors.has('startdate') }">
                     <has-error :form="form" field="startdate"></has-error>
       <input v-model="form.actionaidsalesreportbydate" type="text" hidden readonly="" name="actionaidsalesreportbydate">
      <label for="exampleInputEmail1">To :</label>
...
<option v-for='data in brancheslist' v-bind:value='data.id'> {{ data.branchname }}</option>
  ...
  <button type="submit" id="submit" style="display:none" name= "submit" ref="mybtnforgrneralsalesreport" class="btn btn-primary btn-sm">Saveit</button>         
         
          </div>
                </form>
                                      <div class="bethapa-table-header">
                      GENERAL SALES REPORT : From {{ generalreportselectedstartdate|myDate2 }} To : {{ generalreportselectedenddate|myDate2 }}
...
<table class="table" border="1">
    <thead>
        <tr>
          <th rowspan="1" style="font-size: 30px; background-color: white; border:none "></th>
            ...
            <th rowspan="1" style="font-size: 30px; background-color: white; "></th>
                 <th colspan="5"  style="font-size: 30px; background-color: green; color:white; text-align: center; "> TOTAL ({{currencydetails}} )</th>
          <th colspan="5" style="font-size: 30px; background-color: orange; color:white; text-align: center; ">FISH ({{currencydetails}} ) </th>
            <th colspan="5"  style="font-size: 30px; background-color: maroon; color:white; text-align: center; ">VIRTUAL ({{currencydetails}} )</th>
 ...
 <td>   <template v-if="submenuinfo.generalsalesreport_country">	{{submenuinfo.generalsalesreport_country.countryname}}</template></td>  
            
<td>   <template v-if="submenuinfo.generalsalesreport_company">	{{submenuinfo.generalsalesreport_company.companyname}}</template></td>  
      ...
      <td  style="background-color: #32773280; text-align: right;  ">  {{formatPrice(( (submenuinfo.totalsales )  ))}} </td>
      <!-- <td style="background-color: #32773280; "> {{formatPrice((submenuinfo.totalcancelled))}} </td> -->
      <td style="background-color: #32773280; text-align: right;  "> {{formatPrice((submenuinfo.totalpayout))}} </td>
...
<td style="background-color: #32773280; text-align: right;  "> {{formatPrice(submenuinfo.totalprofit)}} </td>    
<td style="background-color: #32773280; text-align: center; ">
  <div v-if="(submenuinfo.totalsales) == 0 " > -  </div>
  <div v-if="(submenuinfo.totalsales) != 0 " >
  ...
  <td style="background-color: rgb(250 166 48 / 22%); text-align: right;  "> {{formatPrice((submenuinfo.daysalesamount))}} </td>
  <td style="background-color: rgb(250 166 48 / 22%); text-align: right;  " > {{formatPrice((submenuinfo.daypayoutamount))}} </td>
  
  <td style="background-color: rgb(250 166 48 / 22%);  text-align: center; ">
  ...
  <td style="background-color: rgb(250 166 48 / 22%); text-align: right;  "> {{formatPrice((submenuinfo.daysalesamount - submenuinfo.daypayoutamount))}} </td>
 ...
 {{parseFloat(((submenuinfo.daysalesamount - submenuinfo.daypayoutamount) /(submenuinfo.daysalesamount))*100).toFixed(0)}}%
   ...
   <div  v-if="submenuinfo.daysalesamount == 0 "> -  </div>
                         ...
                         <!-- ssssssssssssssssssssssssssssssssssssssssss  -->
     <td style="background-color: #80000069; text-align: right;  "> {{formatPrice((submenuinfo.virtualsales))}} </td>
     
     <td style="background-color: #80000069; text-align: right;  "> {{formatPrice((submenuinfo.virtualpayout))}} </td>
 ...
 <td style="background-color: #80000069; text-align: center; ">
   <div v-if="(submenuinfo.virtualsales - submenuinfo.virtualcancelled) != 0 ">
     {{parseFloat(((submenuinfo.virtualpayout) / ((submenuinfo.virtualsales)) )*100).toFixed(0)}}% 
   </div>
   <div v-if="(submenuinfo.virtualsales) == 0 ">   - </div>
     </td>
 ...
 <td style="background-color: #80000069; text-align: right; " >
   <div v-if="submenuinfo.virtualpayout == 0 "> - </div>
      <div v-if="submenuinfo.virtualpayout != 0 "> 
         {{formatPrice((submenuinfo.virtualsales - submenuinfo.virtualpayout))}}
 ...
 <td style="background-color: #80000069; text-align: center; " >
   ...
   {{parseFloat(((submenuinfo.virtualprofit) / (submenuinfo.virtualsales-submenuinfo.virtualcancelled) )*100).toFixed(0)}}%
    ...
    <div v-if="(submenuinfo.virtualsales-submenuinfo.virtualcancelled) == 0 "> -  </div>
        ...
        <td style="text-align: right; ">{{formatPrice(submenuinfo.totalcollection)}}</td>
        <td style="text-align: right; ">{{formatPrice(submenuinfo.totalcredits)}}</td>
        <td style="text-align: right; ">{{formatPrice(submenuinfo.totalcollection - submenuinfo.totalcredits)}}</td>                             
                ...
                <div class="card-body">
                  <div class="d-flex flex-row">
                    ...
                    <div class="ms-2 align-self-center">
                      ...
                      <h6 class="text-muted mb-0">{{currencydetails}} : {{formatPrice(totalmonthlysalesselectedreport) }}</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex flex-row">
                    ...
                    <div class="ms-2 align-self-center">
                      ...
                      <h6 class="text-muted mb-0"> {{currencydetails}}: 
                            {{formatPrice(totalmonthlypayoutselectedreport) }}</h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-row">
                    ...
                    <div class="ms-2 align-self-center">
                      <h3 class="mb-0">Gross Profit </h3>
                      <h6 class="text-muted mb-0"> {{currencydetails}}: {{formatPrice(totalmonthlyprofitselectedreport) }} 
                        ({{parseFloat(((totalmonthlyprofitselectedreport) /(totalmonthlysalesselectedreport))*100).toFixed(0)}}%)
                      </h6>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex flex-row">
                    ...
                    <div class="ms-2 align-self-center">
                      ...
                      <h6 class="text-muted mb-0"> {{currencydetails}}:
                              {{formatPrice(totalmonthlycollectionsselectedreport) }}</h6>
                    </div>
                  </div>
                </div>
              </div>
...
<option v-for='data in yearslist' v-bind:value='data.id'> {{ data.yearname }}</option>
       ...
       <select v-show="lut == '1'"  name ="type" v-model="form.countryname" v-on:change="myClickEventtosavesalesreportbydate2" id ="countryname" :class="{'is-invalid': form.errors.has('countryname')}"
...
<option v-for='data in monthreportslist2' v-bind:value='data.sysname'> {{ data.sortname }}</option>
 ...
 <div class="bethapa-table-header" v-if="mothlyreportmonth == '01'" > BRANCHES MONTHLY REPORT : January - {{mothlyreportyear}} </div>   
 <div class="bethapa-table-header" v-if="mothlyreportmonth == '02'" > BRANCHES MONTHLY REPORT : Febuary - {{mothlyreportyear}} </div>   
 <div class="bethapa-table-header" v-if="mothlyreportmonth == '03'" > BRANCHES MONTHLY REPORT : March - {{mothlyreportyear}} </div>   
 <div class="bethapa-table-header" v-if="mothlyreportmonth == '04'" > BRANCHES MONTHLY REPORT : April - {{mothlyreportyear}} </div>   

  <div class="bethapa-table-header" v-if="mothlyreportmonth == '05'" > BRANCHES MONTHLY REPORT : May - {{mothlyreportyear}} </div>    
  <div class="bethapa-table-header" v-if="mothlyreportmonth == '06'" > BRANCHES MONTHLY REPORT : June - {{mothlyreportyear}} </div>   
  <div class="bethapa-table-header" v-if="mothlyreportmonth == '07'" > BRANCHES MONTHLY REPORT : July - {{mothlyreportyear}} </div>   
  <div class="bethapa-table-header" v-if="mothlyreportmonth == '08'" > BRANCHES MONTHLY REPORT : August - {{mothlyreportyear}} </div>   
  <div class="bethapa-table-header" v-if="mothlyreportmonth == '09'" > BRANCHES MONTHLY REPORT : September - {{mothlyreportyear}} </div>   
  <div class="bethapa-table-header" v-if="mothlyreportmonth == '10'" > BRANCHES MONTHLY REPORT : October - {{mothlyreportyear}} </div>   
  <div class="bethapa-table-header" v-if="mothlyreportmonth == '11'" > BRANCHES MONTHLY REPORT : November - {{mothlyreportyear}} </div>   
  <div class="bethapa-table-header" v-if="mothlyreportmonth == '12'" > BRANCHES MONTHLY REPORT : December - {{mothlyreportyear}} </div> 
              ...
              <table class="table" border="1"  >
                  ...
                  <tbody>
                    <tr>
                     ...
                     <td>   <template v-if="mrhdghh.branchname_dailycodes">	{{mrhdghh.branchname_dailycodes.branchname}}</template></td> 
                     <td>   <template v-if="mrhdghh.branchname_dailycodes">	{{mrhdghh.branchname_dailycodes.branchname}}</template></td>  
                     <td style="text-align: right;">{{formatPrice(mrhdghh.sales)}}</td>
                     <td style="text-align: right;">{{formatPrice(mrhdghh.payout)}}</td>
                      <td style="text-align: center;">{{parseFloat(((mrhdghh.payout) /(mrhdghh.sales))*100).toFixed(0)}}% </td>
                      <td style="text-align: right;">{{formatPrice(mrhdghh.profit)}}</td>
                       <td style="text-align: center;">{{parseFloat(((mrhdghh.profit) /(mrhdghh.sales))*100).toFixed(0)}}% </td>
                      <td style="text-align: right;">{{formatPrice(mrhdghh.collections)}}</td>
                      <td style="text-align: right;">{{formatPrice(mrhdghh.credits)}}</td>
 ...
 <label for="exampleInputEmail1">Month :</label>
         ...
         <select name ="monthname" v-model="form.monthname" v-on:change="myClickEventtosavesalesreportbydate55" id ="monthname"  :class="{'is-invalid': form.errors.has('monthname')}">
<option value="">  </option>
<option v-for='data in montheslist' v-bind:value='data.monthno'> {{ data.monthname }}</option>
 ...
 <label for="exampleInputEmail1">Year  :</label>
         ...
         <select name ="yearname" v-model="form.yearname"  v-on:change="myClickEventtosavesalesreportbydate55" id ="yearname"  :class="{'is-invalid': form.errors.has('yearname')}">
<option value="">  </option>
<option v-for='data in yearslist' v-bind:value='data.id'> {{ data.yearname }}</option>
       ...
       <select name ="type" v-model="form.countryname" v-on:change="myClickEventtosavesalesreportbydate55" id ="countryname" :class="{'is-invalid': form.errors.has('countryname')}"
                                       data-live-search="true">
                                        <option></option>
                                        <option v-for='data in countrieslist' :value='data.id'>{{ data.countryname }}</option>
                                    </select>
                                        ...
                                        <label for="password_2">Company</label>
                                             ...
                                             v-on:change="myClickEventtosavesalesreportbydate55" 
             ...
             <button type="submit" style="display:none" id="submit" hidden="hidden" name= "submit" ref="mybtnforgrneralsalesreport55" class="btn btn-primary btn-sm">Saveit</button>         
          ...
          <table class="table" border="1">
                  <thead>
                    <tr>
                  <!-- branchname, totalmonthlyexpense, totalmonthlyprofit, totalmonthlyexpenses, monthname, yearname, expecteddailyreturn, 
                 constantmonthlyexpenses, otherexpenses, totalexpensesforthemonth, ucret, created_at, updated_at   -->
                      <th > # </th>
                      <th > COUNTRY</th>
                    <th > COMPANY </th>
                      <th > BRANCH </th>
                  ...
                  <tbody>
                    <tr>
                                       ...
                                       <tr v-for="allmainmenus in branchperformancereportrecords.data" :key="allmainmenus.id">
         ...
         <!-- <td>   <template v-if="allmainmenus.country_branchperformancereport">	{{allmainmenus.country_branchperformancereport.countryname}}</template></td> -->
                  <td>{{allmainmenus.id}}</td>
              <td><template v-if="allmainmenus.country_branchperformancereport">	{{allmainmenus.country_branchperformancereport.countryname}}</template></td>
              <td><template v-if="allmainmenus.company_branchperformancereport">	{{allmainmenus.company_branchperformancereport.companyname}}</template></td>
              <td><template v-if="allmainmenus.branch_branchperformancereport">	{{allmainmenus.branch_branchperformancereport.branchname}}</template></td>
                          <td style="text-align:right"> {{formatPrice(allmainmenus.totalmonthlyprofit)}}</td>
                          <td>
                            <div v-if="allmainmenus.monthname == '01'"> January - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '02'"> Febuary - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '03'"> March - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '04'"> April - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '05'"> May - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '06'"> June - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '07'"> July - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '08'"> August - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '09'"> September - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '10'"> October - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '11'"> November - {{allmainmenus.yearname}} </div>
                            <div v-if="allmainmenus.monthname == '12'"> December - {{allmainmenus.yearname}} </div>
                          </td>
                            <td style="text-align:right"> {{formatPrice(allmainmenus.totalmonthlyexpense)}}</td>
                            <td style="text-align:right"> {{formatPrice(allmainmenus.otherexpenses)}}</td>
                               <td style="text-align:right"> {{formatPrice((allmainmenus.otherexpenses)+(allmainmenus.totalmonthlyexpense))}}</td>                          
                        <td style="text-align:right"> {{formatPrice(((allmainmenus.otherexpenses)+(allmainmenus.totalmonthlyexpense)/30))}}</td> 
                          <td style="text-align:right"> {{formatPrice(((allmainmenus.totalmonthlyprofit)/30))}}</td> 
                           
<td style="text-align:right"> {{formatPrice((allmainmenus.totalmonthlyprofit)-((allmainmenus.otherexpenses)+(allmainmenus.totalmonthlyexpense)))}}</td>    
...
<div class="modal fade" id="addnewshopbalancingrecord" data-backdrop="static">
         <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3  v-show="!editmode"    class="modal-title">
  <img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">Add New Balancing Record</h3> 
                <h4  v-show="editmode" class="modal-title" >UPDATE RECORD</h4> 
                        </div>
                  <form class="form-horizontal" @submit.prevent="editmode ? updateCompanydetails():createBalancingrecord()"> 
 ...
 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                               <has-error :form="form" field="branchnametobalance"></has-error>
                                               <select name ="branchnametobalance" v-model="form.branchnametobalance" v-on:change="myClickEventsavennn"  id ="branchnametobalance" :class="{'is-invalid': form.errors.has('branchnametobalance')}"
                                      class="form-control show-tick" data-live-search="true">
                                        <option></option>
  ...
  <button type="submit" id="submit" style="display:none" hidden="hidden" name= "submit" ref="btnForshopbalancing" class="btn btn-primary btn-sm">Saveit</button>
               </form>
...
<div class ="bethapa-table-sectionheader"> Soccer Details {{fishmachinestotal}}</div>
       <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Sales</label>
                                    </div>
                      ...
                      class="form-control" :class="{ 'is-invalid': form.errors.has('scsales') }">
                                 ...
                                 <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Tickets</label>
                                    </div>
...
<div class ="bethapa-table-sectionheader">Virtual Details {{fishmachinestotal}}</div>
     <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Sales</label>
                                    </div>
     ...
     <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Payout</label>
                                    </div>
     ...
     <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Cancelled</label>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                              <has-error :form="form" field="vcan"></has-error>
                                                <input v-model="form.vcan" type="number" name="vcan"
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                              <has-error :form="form" field="vtkts"></has-error>
                                                <input v-model="form.vcan" type="number" name="vtkts"
...
<div class ="bethapa-table-sectionheader">Fish Hunting Details {{fishmachinestotal}}</div>
...
<div v-if=" fishmachinestotal == 1">
 <div class ="bethapa-table-miniheader">Machine one</div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Current Code</label>
                                    </div>
    ...
    <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Float</label>
                                    </div>
...
<div class ="bethapa-table-sectionheader">Shop details</div>
  ...
  <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Cash at hand</label>
                                    </div>
                      ...
                      class="form-control" :class="{ 'is-invalid': form.errors.has('reportedcash') }">
                        ...
                        <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Shop Comment</label>
                                    </div>
                  ...
                  <div  class="modal-footer">
                    ...
                    <button v-if="branchbalancedforthisdate < 1" v-show="!editmode" type="submit" class="btn btn-primary btn-sm">Create</button> 
...
<div class="modal fade" id="addnewcashcredit" data-backdrop="static">
         <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3  v-show="!editmode"    class="modal-title"><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">NEW SHOP CREDIT</h3> 
                <h4  v-show="editmode" class="modal-title" >UPDATE RECORD</h4> 
                        </div>
                  <form class="form-horizontal" @submit.prevent="editmode ? updateCompanydetails():CreateNewcashcredit()"> 
...
shopbalancngname: null,
       ...
       ////////////////////////////////////////////////////////////////////////////////////
          ...
          branchperformancereportrecords:{},
...
actionaidsalesreportbydate: 'salesdetailsbybranch',
...
myClickEventtosavesalesreportbydate55($event) { const elem = this.$refs.mybtnforgrneralsalesreport55
            elem.click()
        },
myClickEventtosavesalesreportbydate2($event) { const elem = this.$refs.mybtnforgrneralsalesreport2
            elem.click()
        },
        myClickEventtosavesalesreportbydate($event) { const elem = this.$refs.mybtnforgrneralsalesreport
            elem.click()
        },
  saveDatesforgeneralreport(){
...
axios.get("api/seleceteddatefordailyreport").then(({ data }) => (this.seleceteddatefordailyreport = data));
 ...
 loadGeneralreportsales(){
       axios.get("api/salesrecs").then(({ data }) => (this.salesdetailsrecords = data));
 },

 loadstartandenddatesgenreal(){
axios.get("api/generalreportselectedenddate").then(({ data }) => (this.generalreportselectedenddate = data));
 axios.get("api/generalreportselectedstartdate").then(({ data }) => (this.generalreportselectedstartdate = data));
  ...
  myClickEventtosavedates($event) { const elem = this.$refs.myBtntosavedates
            elem.click()
        },
  savenewRecordtoview(){
this.loading = true;
...
/////////
 ...
 startdatedailysalesreport: function(){ axios.get("api/seleceteddatefordailyreportenddate").then(({ data }) => (this.seleceteddatefordailyreportenddate = data));},
 enddatedailysalesreport: function(){axios.get("api/seleceteddatefordailyreport").then(({ data }) => (this.seleceteddatefordailyreport = data));},
...
allwedetodeleteBalancingrecord: function(){axios.get("api/allowedtodeleteshopBalancingRecord").then(({ data }) => (this.allowedtodeleteshopBalancingRecord = data));},
 ...
 getDailysalesreportrecords: function(){ axios.get('/api/dailycodesreportdata').then(function (response) { this.dailycodesreportdata = response.data;}.bind(this));},
...
loadBranchperformancereportrecords(){axios.get("api/branchperformancereportrecords").then(({ data }) => (this.branchperformancereportrecords = data));  },
...
///////////////////////////////////////////////////
        created() {
         ...
         this.getDailysalesreportrecords();
