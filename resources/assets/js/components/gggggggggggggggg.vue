...
<div class="card">
         ...
         <button type="button" class="btn waves-effect waves-light  btn-rounded btn-xs btn-info " @click="viewClientdetails(clientinfo)"> View Details </button> 
                                              </a>  
...
<div class="row">
 ...
 <tr>
                    ...
                    <td>Name </td>
                     <td>:</td>
                      <td>Nakimweero Justine Linda</td>
                ...
                <tr>
                    ...
                    <td>Contact </td>
                     <td>:</td>
                      <td> 0789897645/0704399488</td>
                             </tr>

                              <tr>
                    <td>Joined </td>
                     <td>:</td>
                      <td>November 8th 2022</td>
                             </tr>
              ...
              <div class="card">
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade active show" id="last-month" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div style="margin-top:8.0rem"  class="card-body">

                       <div class="card-body">
                  <center class="mt-4">
                   <!-- <br><br><br><br><br><br> -->

                    <div class="bethapa-table-sectionheader">Next of Kin Information</div>
...
" class="card-title mt-2">     
 ...
 <tr>
    ...
    <div class="bethapa-table-sectionheader">Loans Record</div>
 ...
 <tr>
                    ...
                    <td>Current Out standing </td>
                     <td>:</td>
                      ...
                      <div class="bethapa-table-sectionheader">Savings Record</div>
...
<div
 ...
 <div class="mb-3 row">
   ...
   <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      <label for="fname" class="col-sm-3 text-end control-label col-form-label">Type of ID :</label>
                      <div class="col-sm-9">
