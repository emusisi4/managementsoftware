      ...
      >
        <div class="auth-box p-4 bg-white rounded">
          <div id="loginform">
            ...
            <div class="row">
              <div class="col-12">
              <form  class="form-horizontal mt-3 form-material" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
            @csrf
                
                  <div class="form-group mb-3">
                    <div class="">
                    <input type="email"    placeholder="Username" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="Username" required autofocus>
                            @if ($errors->has('email'))
...
@endif
          ...
          <div id="recoverform">
            ...
            <div class="row mt-3 form-material">
              ...
              <form class="col-12" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
            @csrf
                <!-- email -->
