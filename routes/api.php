...
Route::apiResources(['companyrecords' => 'API\CompaniesController']);
Route::apiResources(['userrecords' => 'API\UserController']);
Route::apiResources(['rolesrecords' => 'API\RolesController']);
Route::apiResources(['newfishcurrentcodes' => 'API\CurrentmacinecodesController']); 
Route::apiResources(['savecompanyinaction' => 'API\CompanyuserregController']);
...
Route::apiResources(['contryinaction' => 'API\CountryinactionController']);
...
Route::apiResources(['incomestotherincomesrecords' => 'API\OtherincomesstatementController']);
...
Route::apiResources(['currentstockvalueupdate' => 'API\UpdatestckvaluesController']);

Route::apiResources(['shitclosing' => 'API\CloseshiftController']);
...
Route::apiResources(['deleteconfirmedpurchaserecord' => 'API\ProductpurchaseDeleteconfirmedController']);
...
Route::get('buyorsaletransaction', 'API\StatementrecordtoviewController@buyorsaletransaction');
...
/////////////
Route::get('incomestatementstartdate', 'APIController@incomestatementstartdate');

Route::get('incomestatementenddate', 'APIController@incomestatementenddate');
Route::get('incomestatementsales', 'APIController@incomestatementsales');
Route::get('incomestatementopenningstock', 'APIController@incomestatementopenningstock');
Route::get('incomestatementclosingstock', 'APIController@incomestatementclosingstock');
Route::get('incomestatementpurchases', 'APIController@incomestatementpurchases');
Route::get('incomestatementcostofsales', 'APIController@incomestatementcostofsales');
Route::get('incomestatementgrossprofit', 'APIController@incomestatementgrossprofit');


Route::get('incomestatementtotalexpenses', 'APIController@incomestatementtotalexpenses');
Route::get('incomestatementotherincomes', 'APIController@incomestatementotherincomes');

Route::get('administrativeexpensestotal', 'APIController@administrativeexpensestotal');

Route::get('financeexpensestotal', 'APIController@financeexpensestotal');

Route::get('operationsexpensestotal', 'APIController@operationsexpensestotal');



Route::apiResources(['financeexpenserecords' => 'API\FinanceexpensesController']);
Route::apiResources(['administrativeexpenserecords' => 'API\AdministrativeexpensesController']);
Route::apiResources(['operationalexpenserecords' => 'API\OperationalexpensesController']);

Route::get('incomestatementadminexp', 'APIController@incomestatementadminexp');
Route::get('incomestatementfinanceexp', 'APIController@incomestatementfinanceexp');



Route::get('generalwalletlist', 'APIController@generalwalletlist');
...
Route::get('customernamestatementprint', 'APIController@customernamestatementprint');


Route::get('customeraddresstoprint', 'APIController@customeraddresstoprint');
Route::get('customeraccountbalance', 'APIController@customeraccountbalance');
Route::get('customertypeprint', 'APIController@customertypeprint');
Route::get('cuctomercontacttoprint', 'APIController@cuctomercontacttoprint');
...
Route::get('isthereclosingstock', 'APIController@isthereclosingstock');
Route::get('shopcashbalance', 'APIController@shopcashbalance');
Route::get('currentstockvalues', 'APIController@currentstockvalues');
Route::get('lastipdatetimeanddate', 'APIController@lastipdatetimeanddate');
...
Route::apiResources(['companymonthlyexpensesrecords' => 'API\MonthlyexpensesController']); 
...
Route::apiResources(['recstofilterwalls' => 'API\RecstofilterwallsController']);
...
Route::apiResources(['cashintransfersshoprecords' => 'API\CashtransferscashinConroller']);
...
Route::apiResources(['approvecashinsent' => 'API\ApprovecashinbranchController']);
...
Route::apiResources(['currentintermbalancingrecords' => 'API\CurrentShopintermbalancingContoller']);
Route::apiResources(['branchperformancereportrecords' => 'API\BranchperformanceContoller']);
...
Route::get('getexpensecategorieslist', 'APIController@getexpensecategorieslist');
Route::get('getexpensetypeslist', 'APIController@getexpensetypeslist');
...
Route::apiResources(['addmonthlyexpensetothecompany' => 'API\MonthlyexpensesController']);
